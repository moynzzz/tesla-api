...
#[AsCommand(
    name: 'moynzzz:tesla-api:register-partner-account',
    description: 'Register a partner account for the Tesla API',
)]
class RegisterPartnerAccountCommand extends Command
{
